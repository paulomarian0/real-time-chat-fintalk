   ...
   return (
      <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md">
         <form onSubmit={handleSubmit}>
            <h1 className="text-2xl font-semibold mb-6">Crie sua própria conta, ou entre anonimamente</h1>
            <div className="mb-4">
            ...
            <Link
               className="underline text-center w-full  border border-transparent rounded-md shadow-sm text-sm font-medium  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
               href={{ pathname: '/login' }}
            >
